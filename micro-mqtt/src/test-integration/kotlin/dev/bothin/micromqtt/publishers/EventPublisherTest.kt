package dev.bothin.micromqtt.publishers
...
class EventPublisherTest {
    ...
    fun `when produce annotation then publish on topic`() {
        ...
        val app = EventApplication(emptyList(), "dev.bothin.micromqtt.publishers", mqttContainer.containerIpAddress, mqttContainer.getMappedPort(1883))
        val kodein = app.run()
